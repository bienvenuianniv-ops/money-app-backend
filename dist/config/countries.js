...
exports.CURRENCY_PRECISION = exports.SUPPORTED_COUNTRIES = void 0;
exports.getCountryByDialCode = getCountryByDialCode;
exports.getCountryByCode = getCountryByCode;
exports.getActiveCountries = getActiveCountries;
...
function getCountryByDialCode(dialCode) {
    return (Object.values(exports.SUPPORTED_COUNTRIES).find((c) => c.dialCode === dialCode && c.isActive) ?? null);
}
/**
 * Retourne le pays par son code ISO
 */
function getCountryByCode(code) {
    return exports.SUPPORTED_COUNTRIES[code.toUpperCase()] ?? null;
}
/**
 * Retourne tous les pays actifs
 */
function getActiveCountries() {
    return Object.values(exports.SUPPORTED_COUNTRIES).filter((c) => c.isActive);
}
/**
 * Vérifie si un pays est supporté et actif
 */
function isCountrySupported(code) {
    const country = exports.SUPPORTED_COUNTRIES[code.toUpperCase()];
